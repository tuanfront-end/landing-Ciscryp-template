...
const data = [
  {
    q: "How does it work?",
    a: `Ciscryp Built with React, Typescript, and the latest Tailwindcss, Headless Ui modern. Perfect starting point for your next NFT Marketplace and NFTs Store `,
  },
