...
const data = [
  ...
  {
    desc: `Really nice, clean and good looking Template. Easy to set up if you read the documentation ;)`,
    name: "Pixelpoldi",
    job: "Customer",
    avatar:
  ...
  {
    desc: `These guys are awesome. New generation of NFT Marketplace site. Cheers :)`,
    name: "Jotiduli",
    job: "Customer",
    avatar:
